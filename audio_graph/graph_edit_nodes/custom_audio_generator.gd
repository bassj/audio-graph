...
@onready var preview: FunctionPlotter = $AudioFunctionOut/Control/FunctionPlotter

@onready var expression_code_edit: CodeEdit = $ExpressionVBox/ExpressionCodeEdit
@onready var expression_error_label: Label = $ExpressionVBox/ExpressionError
